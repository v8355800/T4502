...
type
  ...
  public
    ...
    function  RS(const ADDR: TS3): Word; overload;       // Ðåãèñòð ñîñòîÿíèÿ 16xxx0
    function  RS: Word; overload;                        // Ðåãèñòð ñîñòîÿíèÿ 16xxx0
    procedure  W(const ADDR: TS3; DATA: TS4);            // Âûõîäíîé áóôåð    16xxx2
    function   R(const ADDR: TS3): Word;                 // Âõîäíîé áóôåð     16xxx4
...
//    Out32(fPCI1751.BaseAddr + 5, $FF);  // PB1
  ...
  // 7. Ê ÂÛÂÎÄ = 0
    PC1[6] := 0;
  // 8. Æäåì, ïîêà Ê ÑÈÏ íå ñòàíåò ðàâåí 0
//        while (PC0[2] = 1) do ;
  // 9. Ê ÂÛÂÎÄ = 1
    PC1[6] := 1;
  // 10. Ê ÄÀ = $FFFF
  ...
  // 11. Æäåì, ïîêà Ê ÑÈÏ íå ñòàíåò ðàâåí 1
//        while (PC0[2] = 0) do ;
  // 12. Ê ÑÈÀ = 1
    PC1[3] := 1;
end;
...
begin
  ...
  // 6. Ê ÂÂÎÄ = 0
    PC1[7] := 0;
  // 7. Æäåì, ïîêà Ê ÑÈÏ íå ñòàíåò ðàâåí 0
  //  while (PC0[2] = 1) do ;
  // 8. Ê ÂÂÎÄ = 1
    PC1[7] := 1;
  // 9. Ñ÷èòûâàåì äàííûå
  ...
  // 10. Æäåì, ïîêà Ê ÑÈÏ íå ñòàíåò ðàâåí 1
  //  while (PC0[2] = 0) do ;
  // 11. Ê ÑÈÀ = 1
    PC1[3] := 1;
end;
